<?php
    ...
    if(isset($_FILES['img2']) && $_FILES['img2']['error'] == 0) {
        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            header("Location: editFot.php?id=" .$id2. "&error=Solo se permiten archivos GIF, JPEG, JPG, PNG y WebP.");
            exit;
        }
        ...
        if ($file_size > $max_size) {
            ...
            header("Location: editFot.php?id=" .$id2. "&error=El tamaño máximo permitido es de 1 MB.");
            exit;
        }
